...
|---|---:|---:|---:|
| `CodecParse/uint64/canonical` | 11.7 ns/op | 0 | 0 |
| `CodecParse/uint64/compact` | 11.6 ns/op | 0 | 0 |
| `CodecParse/uint64/bytes` | 11.7 ns/op | 0 | 0 |
| `CodecParse/uint64/invalid` | 10.3 ns/op | 0 | 0 |
| `CodecParse/uint256/canonical` | 52.6 ns/op | 0 | 0 |
| `CodecParse/uint256/max` | 77.2 ns/op | 0 | 0 |
| `AppendTo/uint64/retained` | 2.9 ns/op | 0 | 0 |
| `AppendTo/uint64/formatted` | 13.8 ns/op | 0 | 0 |
| `AppendTo/uint256/formatted` | 148 ns/op | 0 | 0 |
